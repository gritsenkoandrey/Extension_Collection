...
namespace AndreyGritsenko.ExtensionCollection
{
    public static class Utils
    {
        ...
        public static Vector3 GenerateRandomPointAroundObject(float radius)
        {
        ...
        public static Vector3 GenerateExactPointAroundObject(int index, int count, float radius)
        {
